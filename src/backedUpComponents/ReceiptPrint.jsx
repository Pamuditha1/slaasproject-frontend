    ...
    render() {
      ...
      return (
          ...
          <div className="row" id="payment">
            ...
            <div className="col-12" style={{marginTop: '5%'}}>
              <div className="row">
                ...
                <div className="col-9">
                  <label  htmlFor="invoiceNo" className="col-3"><strong>Receipt No</strong></label> 
        ...
        {this.props.type == 'member' &&  
          ...
          <RecordPayment payment={this.state} paymentRecords={this.props.paymentRecords} record={this.recordPayment} changePaymentRecorded={this.changePaymentRecorded} type={this.props.type}/>
        </div>
        </>
      );
    }
