...
export const COLUMNS = [
    {
        Header: 'Application',
        Cell : props => {
            const nic = props.row.original.nic
            return (
                <Link to={`/user/view-application/${nic}`} target="_blank">            
                <button className="btn btn-outline-primary" onClick={() => {console.log('view button clicked', nic )}}>View</button>
                </Link>
            )
        }
    },
