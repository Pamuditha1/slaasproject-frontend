...
function MemberReceipt() {
    ...
    const paymentMethods = ["Select Method","Cash","Bank Draft","Cheque","Online"]
    ...
    switch(step) {
        case 1 : return (
            ...
            <form className="container" autoComplete="off">
                <h6 style={{backgroundColor: "#e95045"}} className="pl-5 pt-1 pb-1 mb-5">Member Payment Receipt</h6>
                ...
                <div className="row">                
                    <div className="col-6">
                        ...
                        <div className="form-group col-12">
                            ...
                            <input onChange={onchangeData} value={paymentData.memberName} className="form-control col-11 ml-3"  type="text" id="memberName" name="memberName" />
                        </div>
                        <div className="form-group col-12">
                            <label htmlFor="nic" className="col-5">NIC</label> 
                            <input onChange={onchangeData} value={paymentData.nic} className="form-control col-11 ml-3" type="text" id="nic" name="nic"/>
                        </div>
                        <div className="form-group col-12">
                            <label htmlFor="paymentMethod" className="col-5">Payment Method</label> 
                            <select onChange={onchangeSelect} value={paymentData.paymentMethod} className="form-control col-11 ml-3" required>
                                {
                ...
                <div className="row">
                    <div className="form-group col-6">
                        <label htmlFor="yearOfPayment" className="col-5">Year of Payment</label> 
                        <input onChange={onchange} value={paymentData.yearOfPayment} className="form-control col-11 ml-3" type="number" id="yearOfPayment" name="yearOfPayment"/>
                    </div>
                    <div className="form-group col-6">
                        <label htmlFor="yearlyFee" className="col-5">Membership Fee</label> 
                        <input onChange={onchange} value={paymentData.yearlyFee} className="form-control col-11 ml-3" type="number" id="yearlyFee" name="yearlyFee"/>
                    </div>
                    {/* <div className="form-group col-6">
                ...
                <div className="row">
                    <div className="form-group col-6">
                        <label htmlFor="arrearsFee" className="col-5">Arrears Fee</label> 
                        <input onChange={onchange} value={paymentData.arrearsFee} className="form-control col-11 ml-3" type="number" id="arrearsFee" name="arrearsFee"/>
                    </div>
                </div>
                <div className="row">
                    <div value={paymentData.description} className="form-group col-12">
                            <label htmlFor="description" className="col-3">Description</label> 
                            <input onChange={onchangeData} className="form-control col-11 ml-3" type="text" id="description" name="description"/>
                    </div>
                </div>
                
                <button onClick={onSubmit} type="submit" className="btn btn-primary float-right m-1">Continue</button>
        ...
        case 2 : return (
            <ReceiptGenerator invoiceNum={invoiceNum} setInvoiceNum={setInvoiceNum} 
            paymentData={paymentData} paymentRecords={paymentRecords} setStep={setStep} type={type}/>
        )
    }
