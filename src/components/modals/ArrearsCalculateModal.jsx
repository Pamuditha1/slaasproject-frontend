...
function ArrearsCalculateModal({isModalOpen, setisModalOpen, setArr}) {
    ...
    return (
        ...
        {/* <Button color="danger" onClick={toggle}>Open</Button> */}
            <Modal isOpen={isModalOpen} toggle={toggle} >
                ...
                <ModalFooter>
                    <Button color="warning" onClick={onCalculate}>Calculate</Button>            
...
export default ArrearsCalculateModal
