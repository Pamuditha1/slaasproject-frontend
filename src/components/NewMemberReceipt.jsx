    ...
    switch(step) {
        case 1 : return (
            ...
            <form className="container" autoComplete="off">
                <h6 style={{backgroundColor: "#e95045"}} className="pl-5 pt-1 pb-1 mb-5">New Payment Receipt</h6>
                ...
                <div className="row">
                    <div value={paymentData.description} className="form-group col-12">
                            ...
                            <input onChangeD={onchangeData} className="form-control col-11 ml-3" type="text" id="description" name="description"/>
                    </div>
                </div>
