    ...
    switch(step) {
        case 1 : return (
            ...
            <form className="container" autoComplete="off">
                <h6 style={{backgroundColor: "#e95045"}} className="pl-5 pt-1 pb-1 mb-5">Payment Receipt</h6>
                ...
                <div className="row">                
                    <div className="col-6">
                        ...
                        <div className="form-group col-12">
                            ...
                            <input onChange={onchange} value={paymentData.memberName} className="form-control col-11 ml-3"  type="text" id="memberName" name="memberName" />
                        </div>
                        <div className="form-group col-12">
                            <label htmlFor="nic" className="col-5">NIC</label> 
                            <input onChange={onchange} value={paymentData.nic} className="form-control col-11 ml-3" type="text" id="nic" name="nic"/>
                        </div>
                        <div className="form-group col-12">
                ...
                <div className="row">
                    ...
                    <div className="form-group col-6">
                        <label htmlFor="yearlyFee" className="col-5">Yearly Fee</label> 
                ...
                <div className="row">
                    <div value={paymentData.description} className="form-group col-12">
                            ...
                            <input onChange={onchange} className="form-control col-11 ml-3" type="text" id="description" name="description"/>
                    </div>
                </div>
        ...
        case 2 : return (
            ...
            paymentData={paymentData} paymentRecords={paymentRecords} setStep={setStep}/>
        )
    }
